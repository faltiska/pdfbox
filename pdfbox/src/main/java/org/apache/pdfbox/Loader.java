...
public class Loader {
    ...
    {
        return loadPDF(file, "", MemoryUsageSetting.setupMainMemoryOnly());
    }
     ...
     * @throws IOException in case of a file reading or parsing error
     */
    public static PDDocument loadPDF(File file, MemoryUsageSetting memUsageSetting)
            throws IOException
    {
        return loadPDF(file, "", null, null, memUsageSetting);
    }
    ...
    public static PDDocument loadPDF(File file, String password)
            throws IOException
    {
        return loadPDF(file, password, null, null, MemoryUsageSetting.setupMainMemoryOnly());
    }
    ...
    public static PDDocument loadPDF(File file, String password, MemoryUsageSetting memUsageSetting)
            throws IOException
    {
        return loadPDF(file, password, null, null, memUsageSetting);
    }
    ...
    throws IOException
    {
        return loadPDF(file, password, keyStore, alias, MemoryUsageSetting.setupMainMemoryOnly());
    }
                                     ...
                                     MemoryUsageSetting memUsageSetting) throws IOException
    {
        ...
        try
        {
            return loadPDF(raFile, password, keyStore, alias, memUsageSetting);
        }
    ...
    private static PDDocument loadPDF(RandomAccessBufferedFileInputStream raFile, String password,
    ...
    {
        return loadPDF(input, "", null, null, MemoryUsageSetting.setupMainMemoryOnly());
    }
    ...
    public static PDDocument loadPDF(InputStream input, MemoryUsageSetting memUsageSetting)
            throws IOException
    {
        return loadPDF(input, "", null, null, memUsageSetting);
    }
    ...
    public static PDDocument loadPDF(InputStream input, String password)
            throws IOException
    {
        return loadPDF(input, password, null, null, MemoryUsageSetting.setupMainMemoryOnly());
    }
     ...
     * @throws IOException In case of a reading or parsing error.
     */
    public static PDDocument loadPDF(InputStream input, String password, InputStream keyStore, String alias)
            throws IOException
    {
        return loadPDF(input, password, keyStore, alias, MemoryUsageSetting.setupMainMemoryOnly());
    }
     ...
     * @throws IOException In case of a reading or parsing error.
     */
    public static PDDocument loadPDF(InputStream input, String password, MemoryUsageSetting memUsageSetting)
            throws IOException
    {
        return loadPDF(input, password, null, null, memUsageSetting);
    }
    ...
    public static PDDocument loadPDF(byte[] input, String password)
            throws IOException
    {
        return loadPDF(input, password, null, null);
    }
     ...
     * @throws IOException In case of a reading or parsing error.
     */
    public static PDDocument loadPDF(byte[] input, String password, InputStream keyStore,
